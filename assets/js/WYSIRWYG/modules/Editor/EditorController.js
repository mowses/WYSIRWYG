...
angular.module('WYSIRWYG.modules.Editor', [
	...
	.config(['$provide', function($provide) {
		$provide.decorator('componentDirective', ['$delegate', '$compile', function($delegate, $compile) {
			...
			/*function getEditableAreaScope($element) {
				var editable_area = $element.parents('[editable-area]:first');

				return (editable_area && editable_area.scope());
			}*/
			...
			directive.compile = function($element, attrs) {
				...
				link.post = function(scope, $element, attrs) {
					...
					bb_scope.toggleCtrlBB = function(event) {
